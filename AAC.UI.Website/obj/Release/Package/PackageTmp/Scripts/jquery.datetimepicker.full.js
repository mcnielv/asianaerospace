				...
				.on('xchange.xdsoft', function (event) {
					...
					xchangeTimer = setTimeout(function () {
						...
						line_time = function line_time(h, m) {
						    ...
						    //var halfminutes = dateHelper.formatDate(now, options.formatTime).toString().substring(0, 3) + '30';
						    //time += '<div class="xdsoft_time ' + classes.join(' ') + '" data-hour="' + h + '" data-minute="' + (parseInt(m, 10) + 30) + '">' + halfminutes + '</div>';
						};
