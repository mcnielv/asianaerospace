...
namespace AAC.UI.Website.Controllers.DataManagement
{
    ...
    public class AircraftTypeController : Controller
    {
        ...
        public AircraftTypeController( ApplicationUserManager userManager )
        {
        ...
        [HttpPost]
        public ActionResult Create( AircraftViewModel model )
        {
            string msg = _actypeService.Create( model );
        ...
        {
            string msg = _actypeService.Delete( id );
            return Json( new { Message = msg }, JsonRequestBehavior.AllowGet );
        }
        #endregion
                ...
                bool _search, string searchField, string searchOper, string searchString )
        {
            ...
            IQueryable<AircraftViewModel> aircrafts = _actypeService.GetAll();
            ...
            var sortedRoles = SortIQueryable<AircraftViewModel>( filteredRoles, sidx, sord ).AsEnumerable();
