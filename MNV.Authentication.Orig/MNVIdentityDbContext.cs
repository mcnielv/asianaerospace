using MNV.Authentication.Mapping;
...
namespace MNV.Authentication
{
    public class MNVIdentityDbContext : DbContext
    {
        ...
        public MNVIdentityDbContext() : base( "Aac.Connection" ) { }
        public MNVIdentityDbContext(string connectionString)
